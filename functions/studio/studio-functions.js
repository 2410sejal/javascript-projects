...
function calculateTheAreaOfRectangle(length,width){
 let area = length*width;
 return area;
}
console.log(`The area is ${calculateTheAreaOfRectangle(2,4)}  cm^2.`);
console.log(`The area is ${calculateTheAreaOfRectangle(14,7)}  cm^2.`);
console.log(`The area is ${calculateTheAreaOfRectangle(20)} cm^2.`);
